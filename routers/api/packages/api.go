...
import (
	...
	"creepercoding.dev/routers/api/packages/alpine"
	"creepercoding.dev/routers/api/packages/arch"
	"creepercoding.dev/routers/api/packages/cargo"
	"creepercoding.dev/routers/api/packages/chef"
	"creepercoding.dev/routers/api/packages/composer"
	"creepercoding.dev/routers/api/packages/conan"
	"creepercoding.dev/routers/api/packages/conda"
	"creepercoding.dev/routers/api/packages/container"
	"creepercoding.dev/routers/api/packages/cran"
	"creepercoding.dev/routers/api/packages/debian"
	"creepercoding.dev/routers/api/packages/generic"
	"creepercoding.dev/routers/api/packages/goproxy"
	"creepercoding.dev/routers/api/packages/helm"
	"creepercoding.dev/routers/api/packages/maven"
	"creepercoding.dev/routers/api/packages/npm"
	"creepercoding.dev/routers/api/packages/nuget"
	"creepercoding.dev/routers/api/packages/pub"
	"creepercoding.dev/routers/api/packages/pypi"
	"creepercoding.dev/routers/api/packages/rpm"
	"creepercoding.dev/routers/api/packages/rubygems"
	"creepercoding.dev/routers/api/packages/swift"
	"creepercoding.dev/routers/api/packages/terraform"
	"creepercoding.dev/routers/api/packages/vagrant"
