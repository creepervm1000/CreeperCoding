...
function initPageThemeDarkLight() {
  ...
  const sync = () => document.documentElement.setAttribute('data-creepercoding-theme-dark', String(isDarkTheme()));
  sync();
  // Track system theme changes in case CreeperCoding is using "auto" theme.
