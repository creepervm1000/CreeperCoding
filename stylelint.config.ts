...
const cssVarFiles = [
  ...
  fileURLToPath(new URL('web_src/css/themes/theme-creepercoding-light.css', import.meta.url)),
  fileURLToPath(new URL('web_src/css/themes/theme-creepercoding-dark.css', import.meta.url)),
];
