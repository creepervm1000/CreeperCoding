...
func TestViteManifest(t *testing.T) {
	...
	"web_src/css/themes/theme-creepercoding-dark.css": {
		"file": "css/theme-creepercoding-dark.CyAaQnn5.css",
		"name": "theme-creepercoding-dark",
		"src": "web_src/css/themes/theme-creepercoding-dark.css",
		"isEntry": true
	}
}`
	...
	t.Run("EmptyManifest", func(t *testing.T) {
		...
		assert.Equal(t, "/assets/css/theme-creepercoding-dark.css", AssetURI("web_src/css/themes/theme-creepercoding-dark.css"))
	...
	t.Run("ParseManifest", func(t *testing.T) {
		...
		assert.Equal(t, "/assets/css/theme-creepercoding-dark.CyAaQnn5.css", AssetURI("web_src/css/themes/theme-creepercoding-dark.css"))
		...
		assert.Equal(t, "theme-creepercoding-dark", AssetNameFromHashedPath("css/theme-creepercoding-dark.CyAaQnn5.css"))
		assert.Empty(t, AssetNameFromHashedPath("css/no-such-file.css"))
	})
}
