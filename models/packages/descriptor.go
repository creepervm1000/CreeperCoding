...
import (
	...
	"creepercoding.dev/modules/packages/alpine"
	"creepercoding.dev/modules/packages/arch"
	"creepercoding.dev/modules/packages/cargo"
	"creepercoding.dev/modules/packages/chef"
	"creepercoding.dev/modules/packages/composer"
	"creepercoding.dev/modules/packages/conan"
	"creepercoding.dev/modules/packages/conda"
	"creepercoding.dev/modules/packages/container"
	"creepercoding.dev/modules/packages/cran"
	"creepercoding.dev/modules/packages/debian"
	"creepercoding.dev/modules/packages/helm"
	"creepercoding.dev/modules/packages/maven"
	"creepercoding.dev/modules/packages/npm"
	"creepercoding.dev/modules/packages/nuget"
	"creepercoding.dev/modules/packages/pub"
	"creepercoding.dev/modules/packages/pypi"
	"creepercoding.dev/modules/packages/rpm"
	"creepercoding.dev/modules/packages/rubygems"
	"creepercoding.dev/modules/packages/swift"
	"creepercoding.dev/modules/packages/vagrant"
